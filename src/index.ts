...
Papa.parse<{ name: string; acronym: string; subject_terms: string }>("./data.csv", {
  ...
  complete: (results) => {
    ...
    const COLORS: Record<string, string> = { institution: "#5A75DB", subject: "#FA5A3D" };
